    ...
    void fillItems(Grid<MazeCell*>& maze, const Vector<string>& textMaze) {
        for (int row = 0; row < maze.numRows(); row++) {
            for (int col = 0; col < maze.numCols(); col++) {
                ...
                case 'S':
                    maze[row][col]->contents = "Spellbook";
                    break;
                case 'P':
                    maze[row][col]->contents = "Potion";
                    break;
                case 'W':
                    maze[row][col]->contents = "Wand";
                    break;
                case '*':
                    /* Do nothing. */
                    break;
...
MazeCell* mazeFor(const string& name) {
    ...
    /* Place the items. */
    linearMaze[locations[1]]->contents = "Spellbook";
    linearMaze[locations[2]]->contents = "Potion";
    linearMaze[locations[3]]->contents = "Wand";
...
MazeCell* twistyMazeFor(const string& name) {
    ...
    maze[locations[1]]->contents = "Spellbook";
    maze[locations[2]]->contents = "Potion";
    maze[locations[3]]->contents = "Wand";
